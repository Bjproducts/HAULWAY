...
export default function PrivacyPage() {
  ...
  return <LegalPage eyebrow="YOUR INFORMATION" title="Privacy Policy" updated="August 21, 2026">
    ...
    <p>Driver applicants also provide contact, licence, vehicle, service-area, eligibility, consent, and compliance information. If an application advances, authorized administrators may request supporting documents such as an abstract, registration, insurance, WCB clearance, or business-licence evidence.</p>
    ...
    <h2>Why we use it</h2>
    <ul><li>Verify accounts and prevent fraud or abuse.</li><li>Create, quote, assign, perform, support, and complete requests.</li><li>Send security codes and transactional request updates.</li><li>Review and administer driver applications and compliance.</li><li>Meet legal, safety, accounting, dispute, and security obligations.</li><li>Improve reliability and the customer experience.</li></ul>
    <h2>When information is shared</h2>
    <p>We share only what is reasonably needed with approved drivers assigned to a request, authorized HAULWAY administrators, and service providers that host or protect the service, store data and media, or deliver text messages. Current providers include Netlify, Supabase, and Twilio. Providers may process information outside Canada, where it can be subject to the laws of that jurisdiction.</p>
