...
export default function TermsPage() {
  return <LegalPage eyebrow="THE GROUND RULES" title="Terms of Service" updated="August 21, 2026">
    ...
    <p>HAULWAY owners currently accept and perform requests directly. Arrival times are estimates and can change because of traffic, weather, access, or earlier jobs. The live tracker is an operational estimate, not a guarantee.</p>
    <h2>Payment, cancellation, and completion</h2>
    <p>Prices are shown in Canadian dollars. Follow only payment instructions displayed inside the signed-in HAULWAY experience or confirmed by authorized support. Never send online-banking credentials. Cancellation may be limited after a quote is accepted or Haulway begins travel; reasonable costs already incurred may apply. Review the work before confirming completion and report visible issues promptly through the request chat or support channel.</p>
    <h2>Acceptable use</h2>
    <p>Do not misuse the service, harass a customer or Haulway team member, probe or disrupt our systems, upload malicious or unlawful material, impersonate another person, scrape private information, evade rate limits, or use the service for fraud. We may restrict or terminate access to protect users and the service.</p>
